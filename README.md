## 🎲 Decision Maker — Random Activity Picker
A Flutter project that demonstrates a simple, focused decision-making app. Add your own activities to a list and let the app randomly pick one when you tap “What should I do?”. Great for showcasing input handling, list management, and randomness in Flutter.

## ✨ Features

Username/Email ki jagah: Activity input field

Add activity to list

Edit and Delete items (swipe to delete with Undo)

Reorder list via drag handle

Random pick button to select one activity

Clear list (Floating Action Button)

Bonus: Quick-add chips & selected item highlight

## 🚀 Technologies Used

Flutter (Dart)

Material 3 components (no external packages)

Built-in animations, gestures, state restoration
